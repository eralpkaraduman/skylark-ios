...
- (void) setText:(NSString *)text {
    if (([text isEqualToString:@""] || [text isEqualToString:@""]) && ![self isFirstResponder]) {
    ...
    if ([text isEqualToString:self.placeholder] || [text isEqualToString:@""]) {
        self.textColor = self.placeholderColor;
    }
    else {
...
- (void) endEditing:(NSNotification*) notification {
    ...
    if ([self.realText isEqualToString:@""] || [self.realText isEqualToString:@""]) {
        super.text = self.placeholder;
        self.textColor = self.placeholderColor;
    }
}
